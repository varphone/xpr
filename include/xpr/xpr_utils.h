...
/// Get resulution from ("1920x1080/1920X1080")
/// retval 0 success -1 failed.
int get_resolution_from_string(const char *str, int *width, int *height);

/*
  @brief Get the action nam from key. eg./camera/video/encoder/0/resolution ==> resolution
  @retval success 0, fail -1.
*/
int get_action_from_key(const char *key, char *name, int len);

/*
  @brief Get the action nam from key. eg./system/network/eth0/ipv4/netmask ==> eth0
  @retval success 0, fail -1.
*/
