...
//优化操作码
#ifndef OPTIMIZE_OPERATION_LEVEL
#define OPTIMIZE_OPERATION_LEVEL
typedef enum _OPTIMIZE_OPERATION_LEVEL{
    OPTIMIZE_OPERATION_NONE = 0,
    OPTIMIZE_OPERATION_IMPROVING = 1,
    OPTIMIZE_OPERATION_REDUCING = 2,
};
#endif
