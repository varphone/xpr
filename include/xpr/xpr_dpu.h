...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_Close(XPR_DPU* dpu);

/// @brief Start data process unit
/// @param [in] dpu         DPU instance
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_Start(XPR_DPU* dpu);

/// @brief Stop data process unit
/// @param [in] dpu         DPU instance
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_Stop(XPR_DPU* dpu);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_AddAVFrameCallback(XPR_DPU* dpu, XPR_DPU_AVFrameCallback cb,
                               void* opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_AddStreamBlockCallback(XPR_DPU* dpu, XPR_DPU_StreamBlockCallback cb,
                                   void* opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_DeleteAVFrameCallback(XPR_DPU* dpu, XPR_DPU_AVFrameCallback cb,
                                  void* opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_DeleteStreamBlockCallback(XPR_DPU* dpu,
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_AddEventCallback(XPR_DPU* dpu, XPR_DPU_EventCallback cb,
                             void* opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_DeleteEventCallback(XPR_DPU* dpu, XPR_DPU_EventCallback cb,
                                void* opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_SetRefClockCallback(XPR_DPU* dpu, XPR_DPU_RefClockCallback cb,
                                void* opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_GetRefClockCallback(XPR_DPU* dpu, XPR_DPU_RefClockCallback* cb,
                                void** opaque);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_SetCTS(XPR_DPU* dpu, int64_t ts, int units);

/// @brief Get current timestamp
/// @param [in] dpu         DPU instance
/// @param [in] units       Timestamp precision
/// @return timestamp
int64_t XPR_DPU_GetCTS(XPR_DPU* dpu, int units);
...
int XPR_DPU_SetOption(XPR_DPU* dpu, const char* name, const void* data,
                      int length);
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_GetOption(XPR_DPU* dpu, const char* name, void* buffer, int* size);

/// @brief Print all options to stdout
/// @param [in] dpu         DPU instance
/// @return no value returns
void XPR_DPU_ShowOptions(XPR_DPU* dpu);

/// @brief Get stream codec
/// @param [in] dpu         DPU instance
/// @param [in] streamId    Stream index, based on 0
/// @return fourcc codec
int XPR_DPU_GetStreamCodec(XPR_DPU* dpu, int streamId);

/// @brief Get stream count
/// @param [in] dpu         DPU instance
/// @return number of streams supported
int XPR_DPU_GetStreamCount(XPR_DPU* dpu);

int XPR_DPU_GetStreamParam(XPR_DPU* dpu, int streamId, const char* param,
                           void* buffer, int* size);

int XPR_DPU_SetStreamParam(XPR_DPU* dpu, int streamId, const char* param,
...
/// @retval 0   success
/// @retval -1  failure
int XPR_DPU_WaitForReady(XPR_DPU* dpu);
