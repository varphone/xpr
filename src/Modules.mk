...
$(eval $(call add_driver,DRM,AT24C02,$(XPR_DRM_DRIVER_AT24C02),at24c02.c,,,-lhi_cipher))
...
###############################################################################
ifeq ($(XPR_OSD),y)
$(eval $(call add_driver,OSD,3516C,$(XPR_OSD_DRIVER_3516C),osd/3516c.c osd/text2bitmap.c,,,-lfreetype -lmpi))
libxpr_SRCS += xpr_osd.c
endif
